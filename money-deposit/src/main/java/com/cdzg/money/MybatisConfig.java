...
public class MybatisConfig {
    ...
    @Primary
    @ConfigurationProperties(prefix = "spring.datasource.deposit")
    @Order(1)
    ...
    @Primary
    @Order(2)
    public SqlSessionFactory sqlSessionFactoryForMoney(@Qualifier("depositDataSource") DataSource dataSource) throws Exception {
