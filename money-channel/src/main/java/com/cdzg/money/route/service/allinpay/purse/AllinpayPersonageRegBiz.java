...
/**
 * @Description: 通联个人用户钱包注册服务实现
 * @Author : pc.huang
 * @Date : 2019-04-02 09:14
 */
@Component("ALLINPAY_PURSE_PERSONAGE")
public class AllinpayPersonageRegBiz extends AbstractAllinpayRegProtocol {
    ...
    public PurseRegMembersRequestVo getAllinpayReq(MemberResponseVo member) {
        PurseRegMembersRequestVo purseRegMembersRequestVo = new PurseRegMembersRequestVo();
        ...
        purseRegMembersRequestVo.setPkOrg(orgInfo.getPkOrg());
        return purseRegMembersRequestVo;
    }
